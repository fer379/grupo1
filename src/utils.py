...
def obtenerRegistro(model, **filters):
    ...
    # Armar el diccionario base con los campos propios de Obra
        data = {
            ...
            "expediente_numero": obra.expediente_numero,
        ...
        } if obra.licitacion_oferta_empresa is not None else None

        data["tipo_contratacion"] = {
            "id": str(obra.tipo_contratacion.id),
            "tipo": obra.tipo_contratacion.tipo,
        } if obra.tipo_contratacion is not None else None

        data["mano_obra"] = {
            "id": str(obra.mano_obra.id),
            "dato": obra.mano_obra.dato,
        } if obra.mano_obra is not None else None
